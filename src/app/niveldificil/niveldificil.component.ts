...
@Component({
  selector: 'app-niveldificil',
  templateUrl: './niveldificil.component.html',
  styleUrl: './niveldificil.component.css'
})
export class NiveldificilComponent implements OnInit{
  ...
  getAllQuestions() {
    this.questionsService.getQuestionHard().subscribe(res => {
